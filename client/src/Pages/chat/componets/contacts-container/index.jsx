...
import CreateChannel from "./create-channel/index"
const ContactContainer=()=> {
  ...
  return (
    <div className="relative md:w-[35vw] lg:w-[3-vw] xl:w-[20vw] bg-[#1b1c24] border-r-2 border-[#2f303b] w-full">
       <div className="pt-3">
    ...
    <Logo/>
       ...
       <div className="my-5">
        ...
        <div className="max-h-[3-vh] overflow-auto scrollbar-hidden">
...
const Logo = () => {
    return (
      <div className="flex p-5  justify-start items-center gap-2">
        ...
        <span className="text-3xl font-semibold ">WeChat App</span>
      </div>
    );
  };
